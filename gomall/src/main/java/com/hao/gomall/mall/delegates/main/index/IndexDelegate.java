package com.hao.gomall.mall.delegates.main.index;
...
import com.hao.gomall.mall.delegates.goods.GoodsInfoActivity;
import com.hao.gomall.mall.util.Constants;
import com.hao.gomall_core.activities.zx.qrcode.Constant;
import com.hao.gomall_core.activities.zx.qrcode.ScannerActivity;
...
public class IndexDelegate extends BottomItemDelegate implements IStartGoodsInfo {
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        ...
        iconIndexScan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), ScannerActivity.class);
                intent.putExtra(Constant.EXTRA_IS_ENABLE_SCAN_FROM_PIC, true);
                startActivityForResult(intent, RequestCode.ZX_CAMERA);
            }
        });
    }
